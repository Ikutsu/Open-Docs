...
[マルチプラットフォームプロジェクト](https://kotlinlang.org/docs/multiplatform.html)（マルチプラットフォームモバイルアプリケーション、またはフルスタックWebアプリケーション）で使用できます。マルチプラットフォームプロジェクトでは、以下の[ターゲット](https://kotlinlang.org/docs/multiplatform-dsl-reference.html#targets)がサポートされています。
